...
parser.add_argument('--dataset_train_path', default=r'F:\study\ai\datawhale\cv\brain_data\crop_img\Train\*\*',
                    help='train root path')
parser.add_argument('--dataset_test_path', default=r'F:\study\ai\datawhale\cv\brain_data\crop_img\Test\NC&MCI',
                    help='test root path')
